...
import './App.css';
import { supabase, signIn, signOut, onAuthChange, fetchGames, upsertGame, deleteGame, fetchTeams, upsertTeam, deleteTeam, uploadPlayerPhoto, adminListUsers, adminInviteUser, adminResetPassword, adminToggleBan } from './supabase';
